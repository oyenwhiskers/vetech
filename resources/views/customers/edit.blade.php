            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <textarea name="address" rows="3"
                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 p-2 border">{{ old('address', $customer->address) }}</textarea>
                </div>
            </div>
